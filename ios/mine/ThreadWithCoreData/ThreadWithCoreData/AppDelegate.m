...
-(void) addNewInstance
{
    ...
    int arbitaryInt = arc4random();
    
    Entity* entity = [Entity getEntityById:[NSString stringWithFormat:@"%d", arbitaryInt] ObjectContext:self.managedObjectContext];
    
    entity.entityId = [NSNumber numberWithInt:arbitaryInt];
    
    NSError *err = nil;
    [self.managedObjectContext save:&err];
    if (err) {
        NSLog(@"save error happens");
    }
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    ThreadManager *manager = [[[ThreadManager alloc] init] autorelease];
    manager.persistentStoreCoordinator = [self persistentStoreCoordinator];
    [manager start];
    
//    BlockManager *manager = [[[BlockManager alloc] init] autorelease];
//    manager.persistentStoreCoordinator = [self persistentStoreCoordinator];
//    [manager start];    
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"ThreadWithCoreData" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"ThreadWithCoreData.sqlite"];
